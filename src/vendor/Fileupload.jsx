    ...
    */
    ...
    const projectSearchFunctionality = (param) => {
        ...
        if (activeProjTab === 3) {
            ...
            url = `/transcriptions?page=1`;
        } else if (activeProjTab === 5) {
            url = `/ai-voices?page=1`;
                                    ...
                                    moreOptionsForPDF?.filter(each => deleteOnly ? each.id === 2 : each.id)?.map((item) => {
                                        return (
                                            <li
                                                ...
                                                className="list-item"
                                                onClick={(e) =>
                                                    item?.label === 'Download' ? downloadConvertDocxFile(selectedProjectFile) :
                                                        item?.label === 'Delete' && handleTaskDeleteButton(e, project?.id, selectedProjectFile?.id, selectedProjectFile?.task_assign_info)
                                                }
                                            >
                                                <div className="item-wrap">
                                                                            ...
                                                                            <div className="file-edit-list-table-cell-wrap">
                                                                                ...
                                                                                <div className="file-edit-list-table-cell">
                                                                                    <div className="status-conditions-part dont-open-list">
                                                                                        <Tooltip title='Open in designer' TransitionComponent={Zoom} placement="top">
                                                                                            <button
                                                                                                style={{
                                                                                                    paddingLeft: "30px",
                                                                                                    paddingRight: "30px"
                                                                                        ...
                                                                                        <MoreOptionsIconDesigner project={project} removeDelete={project?.designer_project_detail?.type == 'image_translate' ? true : false} removeEdit={false} assigned={false} selectedProjectFile={null} />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>   
                                                                                                                            ...
                                                                                                                            <>
                                                                                                                                {
                                                                                                                                    selectedProjectFile?.open_in === 'google-ocr' ? (
                                                                                                                                        <>
                                                                                                                                            ...
                                                                                                                                            <Tooltip className="dont-open-list" title={t("download")} placement="top">
                                                                                                                                                <span className="mr-4" onMouseUp={() => downloadConvertDocxFile(selectedProjectFile)}>
                                                                                                                                                    <img
                                                                                                                                                    ...
                                                                                                                                                    <>
                                                                                                                                                        <Tooltip className="dont-open-list" title={t("download")} placement="top">
                                                                                                                                                            <button
                                                                                                                                                                ...
                                                                                                                                                                className="workspace-files-OpenProjectButton" type="button" onMouseUp={() => downloadConvertDocxFile(selectedProjectFile)}>
                                                                                                                                                                <span className="fileopen-new-btn">{t("download")}</span>
                                                                                                                                                            </button>
                                                                                                                                                        </Tooltip>
                                                                                                                                                        <MoreOptionsIcon selectedProjectFile={selectedProjectFile} project={project} onlyDelete={true} disabled={selectedProjectFile?.pre_trans_processing} />
