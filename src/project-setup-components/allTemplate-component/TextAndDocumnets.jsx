    ...
    const getCardContent = async() => {
        ...
        if (data.status === 200) {
            ...
            newItem = AppsCardsInfo.flat(1)?.filter((newVal) => {
                return newVal.attributes?.category === "Text and Documents";
            });
            setDataItem(newItem);
                            ...
                            <div className="templates-box-row">
                                {
                                    ...
                                    (dataItem?.map((item, index) => {
                                        return(
                                            <div key={index} className="template-box-item-wrapper">
...
export default TextAndDocuments;